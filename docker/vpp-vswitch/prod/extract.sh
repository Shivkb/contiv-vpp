...
docker cp ${CID}:/root/go/src/github.com/Shivkb/contiv-vpp/cmd/contiv-init/contiv-init binaries/
docker cp ${CID}:/root/go/src/github.com/Shivkb/contiv-vpp/cmd/contiv-agent/contiv-agent binaries/
